...
make -f core_make_arm.mk build -j2
make -f core_make_m32.mk build -j2
make -f core_make_p32.mk build -j4
make -f core_make_a64.mk build -j8
make -f core_make_m64.mk build -j8
make -f core_make_p64.mk build -j12
