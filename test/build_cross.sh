...
make -f core_make_arm.mk build -j16
make -f core_make_m32.mk build -j16
make -f core_make_p32.mk build -j16
make -f core_make_a64.mk build -j16
make -f core_make_m64.mk build -j16
make -f core_make_p64.mk build -j16

make -f core_make_arm.mk strip
make -f core_make_m32.mk strip
make -f core_make_p32.mk strip
make -f core_make_a64.mk strip
make -f core_make_m64.mk strip
make -f core_make_p64.mk strip
