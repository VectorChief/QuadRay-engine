...
make -f core_make_arm.mk clean
make -f core_make_m32.mk clean
make -f core_make_p32.mk clean
make -f core_make_a64.mk clean
make -f core_make_m64.mk clean
make -f core_make_p64.mk clean
